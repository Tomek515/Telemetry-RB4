...
struct gpiod_line_request_config {
  ...
  inline int         gpiod_line_event_wait(gpiod_line*, const struct timespec*) { return 0; } // brak zdarzeń
  inline int         gpiod_line_event_read(gpiod_line*, struct gpiod_line_event*) { return -1; }
